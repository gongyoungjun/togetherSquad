				...
				<form name="login" method="POST"
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<a href="" id="confirmpay" class="btn btn-sm btn-info btn-block" style="background-color: #141414">확인</a>
						</div>
						
						<div class="col-xs-12 col-sm-12 col-md-12">
							<a href="" id="cancelpay" class="btn btn-sm btn-info btn-block" style="background-color: #141414" onclick="self.close();">취소</a>
						</div>
					</div>
				</form>					
			</div>
